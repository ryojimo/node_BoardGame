 ...
 * @constructor
 * @example
 * let obj = new DataBoardGame(jsonObj);
*/
class DataBoardGame {
  ...
  constructor(jsonObj) {
    this.data = {
      ...
      url: "",                // @type {string} : URL
      price: "",              // @type {string} : 価格
      play_time: "",          // @type {string} : プレイ時間
      players: "",            // @type {string} : プレイ人数
      comment_recommend: "",  // @type {string} : 購入推薦コメント
      comment: "",            // @type {string} : 備考
      arrival_date: "",       // @type {string} : 購入日
    };
